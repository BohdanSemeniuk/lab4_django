...
class Category(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = u'Категорії для публікацій'
...
class Article(models.Model):
    ...
    pub_date = models.DateTimeField(u'Дата публікації', default=timezone.now)
    slug = models.SlugField(u'Слаг', unique_for_date='pub_date')
    main_page = models.BooleanField(u'Головна', default=False, help_text=u'Показувати на головій сторінці')
    category = models.ForeignKey(Category, related_name='articles', verbose_name=u'Категорія', blank=True, null=True,
